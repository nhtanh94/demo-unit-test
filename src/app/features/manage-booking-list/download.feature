Feature: Tải lịch khám
Feature Desscription: Tải lịch khám theo mã, tên bệnh nhân, số điện thoại, nơi khám bệnh, khu khám,
loại hình khám, chuyên khoa, phòng khám, bác sĩ, trạng thái thanh toán, thời gian
  ...
  Scenario Outline: Tải lịch khám
     ...
     And Chọn khu khám trong ô dropdown <examtypeId>
      And Chọn chuyên khoa trong ô dropdown <specialityId>
       And Chọn phòng khám trong ô dropdown <roomId>
        ...
        And Click nút tải về
        Then Trình duyệt download lịch khám đuôi exel
  Examples:
